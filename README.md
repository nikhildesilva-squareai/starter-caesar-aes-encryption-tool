# Caesar/AES Encryption Tool

![Beginner](https://img.shields.io/badge/difficulty-beginner-22C55E) ![Cybersecurity](https://img.shields.io/badge/course-Cybersecurity-0056CE) ![8 hours](https://img.shields.io/badge/estimated-8h-lightgrey)

> **Square 1 AI** starter template — Cybersecurity

## Overview

In this introductory project, you'll build a **Caesar/AES Encryption Tool** using Python, Cryptography, AES. Implement classical and modern encryption algorithms with a CLI interface. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-caesar-aes-encryption-tool.git
cd starter-caesar-aes-encryption-tool
